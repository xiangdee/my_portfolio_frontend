                        ...
                        <nav className="nav">
                                ...
                                <div className="flex flex-row justify-end">
                                        ...
                                        <ul className={`${navOpen ? 'visible translate-y-1' : 'invisible '} dropDown`}>
                                            <li><Link href={"/"} onClick={()=>setNavOpen(false)}>01. Home</Link></li>
                                            <li><a href={"#about"} onClick={()=>setNavOpen(false)}>02. About</a></li>
                                            <li><a href={"#resume"} onClick={()=>setNavOpen(false)}>03. Resume</a></li>
                                            <li><a href={"#works"} onClick={()=>setNavOpen(false)}>04. Works</a></li>
                                            <li><a href={"#contact"} onClick={()=>setNavOpen(false)}>05. Contact</a></li>
                                        </ul>
                                        </div>
