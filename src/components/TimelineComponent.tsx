  ...
  return (
    <div className="timeline mt-5 md:ml-32">
                    ...
                    <div className="event">
                      ...
                      <div className="eventContent">
                        <h3 className='text-xl text-primary'>Fullstack Engineer</h3>
                        <h4 className='text-xl'>Surfmeal</h4>
                        <p className='text-sm'>
                        Developed a comprehensive food delivery platform, Surfmeal, creating a user-friendly 
                        React Native app for customers and a streamlined management interface for vendors. 
                        Built an engaging, responsive Next.js landing page with Tailwind CSS, showcasing the app&rsquo;s 
                        unique features and user benefits. Leveraged NestJS and Prisma for backend services, implementing 
                        a robust API that handles user authentication, store management, and real-time order tracking. 
                        Integrated diverse payment methods, including wallets and gift cards, enhancing in-app transaction 
                        convenience. Architected and deployed the platform on AWS using Docker and GitHub Actions, 
                        ensuring scalability, security, and smooth updates across services.
